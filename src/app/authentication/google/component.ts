...
@Component({
  selector: 'authentication-google-page',
  templateUrl: './index.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class AuthenticationGooglePage implements OnInit{
  ...
  ngOnInit() {
    ...
    return this.AuthenticationProvider.googleAuth(code).then(({ result }) => {
